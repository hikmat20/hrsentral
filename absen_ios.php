...
<head>
	...
	<title>HR SYSTEM | Absensi IOS</title>
	...
	if (isIos) {
	  ...
	  window.location.replace("absen.php");
	}
	</script>
</head>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-12">
					<div class="panel panel-primary">
						<div class="panel-heading"><center>
							...
							<p><input type="file" accept="image/*" capture name="image" id="file"  onchange="loadFile(event)" style="display: none;"></p>
							<p><label for="file" style="cursor: pointer;" class="btn btn-danger">Ambil Gambar</label></p>							
							<br />
							<div id="results"></div>
							</center>
						</div>
	...
	<script language="JavaScript">
		...
		var loadFile = function(event) {
			...
			FR.addEventListener("load", function(e) {
			  ...
			  document.getElementById('results').innerHTML = '<img src="' + e.target.result + '" height="300" class="img-responsive" />';			
			});			
