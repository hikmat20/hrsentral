...
class Employees_model extends CI_Model { 
	...
	public function prismakontrak1Numrows()
	{
		...
		$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
		$this->db->join('positions j', 'j.id=a.position_id', 'left');
		$this->db->where(array('a.company_id'=>'COM003','a.firstcontract_id'=>'CTR001',
	...
	public function prismakontrak2Numrows()
	{
		...
		$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
		$this->db->join('positions j', 'j.id=a.position_id', 'left');
		$this->db->where(array('a.company_id'=>'COM003','a.secondcontract_id'=>'CTR002',
	...
	public function prismakontrak3Numrows()
	{
		...
		$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
		$this->db->join('positions j', 'j.id=a.position_id', 'left');
		$this->db->where(array('a.company_id'=>'COM003','a.thirdcontract_id'=>'CTR003',
	...
	public function danestkontrak1Numrows()
	{
		...
		$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
		$this->db->join('positions j', 'j.id=a.position_id', 'left');
		$this->db->where(array('a.company_id'=>'COM004','a.firstcontract_id'=>'CTR001',
		'a.secondcontract_id'=>'0','a.thirdcontract_id'=>'0','a.permanent_id'=>'0','a.flag_active'=>'Y'));
		$query = $this->db->get(); 
		//echo "<pre>";print_r($query->result());
		if($query->num_rows() != 0)
	...
	public function danestkontrak2Numrows()
	{
		...
		$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
		$this->db->join('positions j', 'j.id=a.position_id', 'left');
		$this->db->where(array('a.company_id'=>'COM004','a.secondcontract_id'=>'CTR002',
		'a.thirdcontract_id'=>'0','a.permanent_id'=>'0','a.flag_active'=>'Y'));
		$query = $this->db->get(); 
		//echo "<pre>";print_r($query->result());
		if($query->num_rows() != 0)
	...
	public function danestkontrak3Numrows()
	{
		...
		$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
		$this->db->join('positions j', 'j.id=a.position_id', 'left');
		$this->db->where(array('a.company_id'=>'COM004','a.thirdcontract_id'=>'CTR003',
		'a.permanent_id'=>'0','a.flag_active'=>'Y'));
	...
	public function getDataLatestContract1($com)
	{
			...
			$this->db->where(array('a.company_id'=>$com,'a.firstcontract_id'=>'CTR001',
			'a.secondcontract_id'=>'0','a.thirdcontract_id'=>'0','a.permanent_id'=>'0','a.flag_active'=>'Y'));
	...
	public function getDataLatestContract2($com)
	{
			...
			$this->db->join('contracts i', 'i.id=a.permanent_id', 'left');
			$this->db->join('positions j', 'j.id=a.position_id', 'left');
			$this->db->where(array('a.company_id'=>$com,'a.secondcontract_id'=>'CTR002',
			'a.thirdcontract_id'=>'0','a.permanent_id'=>'0','a.flag_active'=>'Y'));
	...
	public function getDataLatestContract3($com)
	{
			...
			$this->db->where(array('a.company_id'=>$com,'a.thirdcontract_id'=>'CTR003',
			'a.permanent_id'=>'0','a.flag_active'=>'Y'));
	...
	function getAbsensirpt($tgl1,$tgl2){
		...
		$query = $this->db->query
			("SELECT a.name,a.date,a.timetable,a.clock_in,a.clock_out,a.created,a.created_by, e.clock_in as clock_in2 , e.clock_out as clock_out2,
		...
		$cariabsen = $this->db->query
		
			("SELECT a.name, COUNT( a.name )AS jumlah, 
	...
	function getSalarycount($tgl1,$tgl2){
		...
		$carigaji = $this->db->query		
					("SELECT a.name as nama, b.*, b.salary, c.*, d.*
					FROM rpt_absensi a
