...
class Permanentdanest extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->getDataPermanentEmpl('COM004');
		$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Danest Permanent Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/danestpermanent',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/danestpermanent_excel',$data);
	}
