...
class Prismasecondcontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->prismakontrak2('COM003');
		//$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Prisma Second Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/prismasecondcontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/prismasecondcontract_excel',$data);
	}
