...
class Absensirpt extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('Absensirpt/index',$data);
	}
	...
	public function search(){
		...
		$Employees			= $this->employees_model->getEmployees();
		$get_Data2			= $this->employees_model->getEmpfamily();
		$get_Data3			= $this->employees_model->getAbsensirpt($tgl1,$tgl2);
		...
		$this->load->view('Absensirpt/report',$data);
	}
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Absensirpt/absensi_excel',$data);
	}
}