...
class Danestsecondcontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->prismakontrak2('COM004');
		//$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Danest Second Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/danestsecondcontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/danestsecondcontract_excel',$data);
	}
