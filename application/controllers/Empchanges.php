...
class Empchanges extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('Empchanges/index',$data);
	}
	...
	public function ubahstatus($id=''){
		...
		if($this->input->post()){
			...
			$this->load->view('Empchanges/edit',$data); 
		}
	}
	...
	public function division($id=''){
		...
		if($this->input->post()){
			...
			$this->load->view('Empchanges/division',$data);
		}
	}
	...
	public function grade($id=''){
		...
		if($this->input->post()){
			...
			$this->load->view('Empchanges/grade',$data);
		}
	}
