...
class Permanentprisma extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->getDataPermanentEmpl('COM003');
		$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Prisma Permanent Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/prismapermanent',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/prismapermanent_excel',$data);
	}
