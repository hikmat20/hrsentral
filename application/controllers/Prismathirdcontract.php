...
class Prismathirdcontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->prismakontrak3('COM003');
		//$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Prisma Third Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/prismathirdcontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/prismathirdcontract_excel',$data);
	}
