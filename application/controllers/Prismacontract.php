...
class Prismacontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->getDataContractEmpl('COM003');
		//$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Prisma Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/prismacontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/prismacontract_excel',$data);
	}
