...
class Danestcontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->getDataContractEmpl('COM004');
		$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Danest Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/danestcontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/danestcontract_excel',$data);
	}
