...
class Danestfirstcontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->prismakontrak1('COM004');
		//$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Danest First Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/danestfirstcontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/danestfirstcontract_excel',$data);
	}
