...
class Danestthirdcontract extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->prismakontrak3('COM004');
		//$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Danest Third Contract Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/danestthirdcontract',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/danestthirdcontract_excel',$data);
	}
