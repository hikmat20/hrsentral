...
class Danestemp extends CI_Controller {
	...
	public function index(){
		...
		$get_Data			= $this->employees_model->getDataCompEmpl('COM004');
		$Employees			= $this->employees_model->getEmployees();
		
		$data = array(
			'title'			=> 'Indeks Of Danest Employees',
			'action'		=> 'index',
		...
		$this->load->view('Employeelist/danest',$data);
	}
	...
	public function excel(){
		...
		history('View Data Employees');
		$this->load->view('Reports/danest_excel',$data);
	}
