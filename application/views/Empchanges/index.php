						...
						elseif($agama=='6')
						{
							...
							echo"<td align='center'>";
								if($akses_menu['update']=='1'){
									echo"<a href='".site_url('empchanges/ubahstatus/'.$datas->id)."' class='btn btn-sm btn-primary' title='Change Status' data-role='qtip'><i class='fa fa-edit'></i></a>";
								}									
								if($akses_menu['update']=='1'){
								echo"<a href='".site_url('empchanges/division/'.$datas->id)."' class='btn btn-sm btn-success' title='Change Division' data-role='qtip'><i class='fa fa-institution'></i></a>";
								}
								if($akses_menu['update']=='1'){
								echo"<a href='".site_url('empchanges/grade/'.$datas->id)."' class='btn btn-sm btn-warning' title='Change Grade' data-role='qtip'><i class='fa fa-signal'></i></a>";
								}
							echo"</td>";	
