...
<div class="box box-solid rounded-1 box-shadow">
    ...
    <div class="box-body">
        <form class="form-horizontal" id="form-leave" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="hidden">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="employee_id" required readonly value="<?= $employee['id']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <input style="margin-top:10px" disabled name="other_request" id="other_request" class="form-control" required="required" placeholder="Asal Permintaan Lainnya">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group text-center doc-sick">
                        <!-- <label for="sick_leave_category" class="col-md-3 col-md-offset-3 text-left">Dok. Pendukung<span class="text-red"></span></label> -->
                        <div class="col-sm-12">
                            <button type="button" id="btn-doc-sick" onclick="$('#doc_sick_leave').click()" class="btn btn-warning" style="margin-bottom:10px"><i class="fa fa-upload"></i> Upload Dok. Pendukung</button>
