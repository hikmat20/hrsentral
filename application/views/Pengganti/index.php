                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($access['approve'] == '1') : ?>
                                <button data-id="<?= $data->id; ?>" class="btn btn-success btn-sm approve" title="Approve Pengajuan" tooltip="qtip"><i class="fa fa-check"></i></button>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.approve', function() {
            ...
            swal({
                ...
                if (value) {
                    $.ajax({
                        url: base_url + active_controller + '/approve',
                        data: {
                            id
                        },
                        type: 'POST',
