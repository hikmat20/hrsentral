                ...
                foreach ($row as $data) : $n++ ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php if ($data->status == 'APV' && $data->approved_hr == 'N') : ?>
                                <a href="<?= base_url('pengganti/update/') . $data->id; ?>" class="btn btn-warning btn-sm edit" title="Edit Pengajuan" tooltip="qtip"><i class="fa fa-pencil"></i></a>
                            <?php endif; ?>
