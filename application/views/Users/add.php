			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
						echo form_input(array('id' => 'username', 'name' => 'username', 'class' => 'form-control input-sm', 'autocomplete' => 'off', 'placeholder' => 'Username'));
						?>
					</div>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						echo form_dropdown('group_id', $data_group, '0', array('id' => 'group_id', 'class' => 'form-control input-sm'));
						?>
					</div>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						echo form_dropdown('employee_id', $data_employees, '0', array('id' => 'employee_id', 'class' => 'form-control input-sm'));
						?>
					</div>
	...
	$(document).ready(function() {
		$('#simpan-bro').click(function(e) {
			...
			if (employee == '' || employee == null || employee == '0') {
				swal({
					title: "Error Message!",
					text: 'Empty Employee, please choose employee first.....',
					type: "warning"
				});
