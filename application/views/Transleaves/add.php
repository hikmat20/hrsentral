		...
		<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							echo form_input(array('id'=>'from','name'=>'from','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Date From'));											
						?>
					</div>
		...
		<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							echo form_input(array('id'=>'until','name'=>'until','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Until'));											
						?>
					</div>
			    ...
			    <label class='label-control col-sm-2'><b>Leave Name<span class='text-red'>*</span></b></label>
					<div class='col-sm-4'>
						...
						<?php
							...
							echo form_dropdown('leave_id',$data_leaves,'0', array('id'=>'leave_id','class'=>'form-control input-sm'));											
						?>
					</div>
					</div>
		</div>		
		<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-file"></i></span>              
						<?php
							echo form_input(array('id'=>'leave','name'=>'leave','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Total Days'));											
						?>
					</div>
