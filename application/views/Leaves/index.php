...
<div class="box box-primary">
	<div class="box-header">
		...
		<div class="box-tool pull-right">
			...
			?>
				<a href="<?php echo site_url('leaves/add') ?>" class="btn btn-sm btn-success" id='btn-add'>
		...
		<table id="example1" class="table table-bordered table-striped">
			<thead>
				<tr class='bg-blue'>
					...
					<th class="text-center">Days Value</th>
			...
			<tbody>
				...
				if ($row) {
					...
					foreach ($row as $datas) {
						...
						echo "<td align='center'>" . $datas->values . " day(s)</td>";
