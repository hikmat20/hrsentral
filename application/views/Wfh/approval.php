        ...
        <div class="box-body">
            <div class="row box-body" id="print_page">
                <div class="text-center">
                    <h3 class="text-bold">PENGAJUAN WFH KARYAWAN</h3>
                ...
                <div class="col-md-10 col-md-offset-1">
                        ...
                        <table class="table table-bordered table-condenseds table-resposive">
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3"><?= date('D, d F Y', strtotime($data->created_at)); ?></td>
                                </tr>
                                <tr>
                                    <td width="">Nama</td>
                                    <td class="text-center">:</td>
                                ...
                                <tr>
                                    <td>Jml. Hari</td>
                                    <td class="text-center">:</td>
                                    <td colspan="3"><?= $data->total_days; ?> hari</td>
                                </tr>
                                <tr>
                                    <td>Alasan</td>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if ($data->status == 'OPN') : ?>
                            ...
                            <button type="button" class="btn btn-success" id="add_work"><i class="fa fa-plus"></i> Rencana Kerja</button>
                        <?php endif; ?>
                    </div>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <textarea rows="3" disabled class="form-control"><?= $data->problems; ?></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="height: 100px;">
                                    <textarea name="notes" <?= ($data->status == 'APV') ? 'disabled' : ''; ?> id="notes" rows="5" class="form-control"><?= $data->note; ?></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
