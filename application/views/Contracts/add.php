...
<form action="#" method="POST" id="form_proses_bro">   
	<div class="box box-primary">
		...
		<div class='form-group row'>			
				<label class='label-control col-sm-2'><b>Contract ID <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>
			...
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-file"></i></span>              
						<?php
							echo form_input(array('id'=>'name','name'=>'name','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Contract Name'));											
						?>
					</div>
