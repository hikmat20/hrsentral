	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Divisions Head ID <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						echo form_dropdown('employee_id', $employee, '0', array('id' => 'employee_id', 'class' => 'form-control input-sm'));
						?>
					</div>
				</div>
			</div>
			<div class='form-group row'>
				...
				<div class='col-sm-4'>
					<?php
					echo form_textarea(array('id' => 'description', 'name' => 'description', 'class' => 'form-control input-sm', 'autocomplete' => 'off', 'placeholder' => 'Description Name', 'rows' => '3'));
					?>
				</div>
			</div>
			<!-- <div class='form-group row'>
				...
				<div class='col-sm-4'>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-file"></i></span>
						<?php
						echo form_input(array('id' => 'name', 'name' => 'name', 'class' => 'form-control input-sm', 'autocomplete' => 'off', 'placeholder' => 'Divisions Name'));
						?>
					</div>
	...
	$(document).ready(function() {
		$('#simpan-bro').click(function(e) {
			...
			if (description == '' || description == null) {
				swal({
					title: "Error Message!",
					text: 'Empty Descriptions, please input Descriptions first.....',
					type: "warning"
				});
