...
<div class="box">
	<div class="box-header">
		<?php if ($akses_menu['create'] == '1') : ?>
			<div class="dropdown">
			  <a class="btn btn-success btn-sm" href="<?=base_url('expense/kasbon_create');?>">
	...
	<div class="box-body"><div class="table-responsive">
		...
		<tr>
			...
			<?php if ($akses_menu['read'] == '1') : ?>
				<a class="btn btn-warning btn-sm view" href="<?=base_url('expense/kasbon_view/'.$record->id)?>" title="View"><i class="fa fa-eye"></i> </a>
			<?php endif;
			if ($akses_menu['update'] == '1') :
				if ($record->status==0) {?>
				<a class="btn btn-success btn-sm edit" href="<?=base_url('expense/kasbon_edit/'.$record->id)?>" title="Edit"><i class="fa fa-edit"></i></a>
				<?php }
				endif;
