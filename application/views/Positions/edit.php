	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>
				<label class='label-control col-sm-2' readonly><b>Position Code <span class='text-red'>*</span></b> </label>
				<div class='col-sm-4'>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-file"></i></span>              
						<?php
							echo form_input(array('readonly'=>'readonly','id'=>'id','name'=>'id','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Position Code'),$row[0]->id);											
						?>
					</div>
	...
	$(document).ready(function(){
		$('#simpan-bro').click(function(){
			...
			if(id=='' || id==null){
				swal({
				  title	: "Error Message!",
				  text	: 'Empty Position Code, please input Position Code first.....',
				  type	: "warning"
				});
				return false;
			}
