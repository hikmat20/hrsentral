...
echo form_open_multipart(site_url(strtolower($this->uri->segment(1).'/upload')),array('id'=>'form_proses_bro'));
?>
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class='form-group row'>			
				<label class='label-control col-sm-2'><b>File Excel <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-file"></i></span>
						<input type="file" name="excel_file" id="excel_file">
						<?php
							//echo form_input(array('type'=>'file','id'=>'file','name'=>'file','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'File'));											
						?>
					</div>
