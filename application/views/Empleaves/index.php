						...
						echo"<tr>";
							...
							echo"<td align='center'>";
							     if($akses_menu['create']=='1'){
									echo"<a href='".site_url('empleaves/add/'.$datas->id)."' class='btn btn-sm btn-success' title='Input Leave' data-role='qtip'><i class='fa fa-plus'></i></a>";
								}
							    if($akses_menu['update']=='1'){
									echo"<a href='".site_url('empleaves/edit/'.$datas->id)."' class='btn btn-sm btn-primary' title='Edit Leave' data-role='qtip'><i class='fa fa-edit'></i></a>";
								}									
