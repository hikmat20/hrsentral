...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('marital/add') ?>" class="btn btn-sm btn-success" id='btn-add'>
			  ...
			  if($row){
					...
					foreach($row as $datas){
						$int++;
							...
							echo"<td align='left'>".$datas->code."</td>";
							echo"<td align='left'>".$datas->name."</td>";
							echo"<td align='center'>";
								if($akses_menu['update']=='1'){
									echo"<a href='".site_url('marital/edit/'.$datas->id)."' class='btn btn-sm btn-primary' title='Edit Data' data-role='qtip'><i class='fa fa-edit'></i></a>";
								}									
