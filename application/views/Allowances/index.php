...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('allowances/add') ?>" class="btn btn-sm btn-success" id='btn-add'>
						...
						echo"<tr>";
							...
							echo"<td align='center'>";
							    if($akses_menu['update']=='1'){
									echo"<a href='".site_url('allowances/edit/'.$datas->id)."' class='btn btn-sm btn-primary' title='Edit Allowances' data-role='qtip'><i class='fa fa-edit'></i></a>";
								}									
