				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							...
							echo form_dropdown('employee_category',$data_position, $row[0]->employee_category, array('id'=>'employee_category','class'=>'form-control input-sm'));											
						?>
		...
		<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-file"></i></span>              
						<?php
							echo form_input(array('id'=>'jumlah','name'=>'jumlah','class'=>'form-control input-sm','autocomplete'=>'off','placeholder'=>'Jumlah'),$row[0]->jumlah);											
						?>
					</div>
