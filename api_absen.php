				...
				if($name==''){
					...
					if(($tipe== '1' && $standar=='') || ($tipe== '4' && $standar=='')){
					  ...
					  if($ceksingleabsen!=""){
						...
						$sql = "insert into absensi_log (employee_id,user_id,foto,waktu,latitude,longitude,tipe,jam_standar,lokasi) values ('".$name."','".$username."','".$fileName."','".date("Y-m-d H:i:s")."','".$latitude."','".$longitude."','".$tipe."','".$jam_standar."','".$lokasi."')";
						mysqli_query($con, $sql);
